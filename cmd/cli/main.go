...
func run() error {
	...
	withoutConfirmation := flag.Bool("withoutConfirmation", false, "ask for confirmation before executing plan")
	flag.Parse()
	...
	return projektove.Synchronize(context.Background(), projAPI, ghAPI, users, *dryRun, *withoutConfirmation)
}
